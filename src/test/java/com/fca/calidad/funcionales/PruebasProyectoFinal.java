...
public class PruebasProyectoFinal {
  ...
  public void testCaseAdd() throws Exception {
    ...
    assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]prueba@gmail\\.com[\\s\\S]$"));
  }
  ...
  public void testCaseEdit() throws Exception {
    ...
    driver.findElement(By.xpath("//i")).click();
    // Warning: assertTextPresent may require manual changes
    assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]prueba2[\\s\\S]$"));
  }
